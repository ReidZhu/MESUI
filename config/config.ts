...
export default defineConfig({
  ...
  theme: {
    ...
    'primary-color': '#489C9C', //主题色
    'table-header-bg': '#489C9C', //table头部底色
    'table-header-color': 'white', //table头部文字颜色
    'table-row-hover-bg': '#7fc7c5', //table选中行底色
    'layout-header-background': '#307676', //顶部背景色
  },
  esbuild: {},
  title: false,
  ...
  // 路由前缀
  // base: '/MES/', // TODO, 当网站根路径是 https://www.baidu.com/app/ 时, 设置为 /app/
  // 静态文件路径
  //publicPath: '/MES/', // TODO, 当网站根路径是 https://www.baidu.com/app/ 时, 设置为 /app/
});
